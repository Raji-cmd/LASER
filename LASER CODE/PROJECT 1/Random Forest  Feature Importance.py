...
data = {
    ...
    "Surface Waviness": [6.07, 4.01, 6.75, 5.10, 6.01, 5.90, 6.05, 5.66, 4.13, 5.23,
                         6.26, 7.32, 4.90, 5.60, 6.44, 6.02, 4.33, 5.94, 6.21,
                         7.10, 4.69, 6.63, 6.43, 4.69],
    "Material Vaporization Rate": [100.71, 74.77, 119.88, 79.11, 93.27, 99.84,
...
targets = {'Surface Waviness': df['Surface Waviness'],
