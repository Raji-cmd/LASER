...
ax.set_title('Surface Waviness', fontsize=16, fontweight='bold')

ax.grid(True, linestyle='--', alpha=0.3)
bold_axes(ax)

cbar = plt.colorbar(scatter)
cbar.set_label('Surface Waviness ', fontsize=12, fontweight='bold')
...
scatter = ax.scatter(df['Number of passes'],
                     df['Laser Frequency'],
                     c=df['Material Vaporization Rate'],
                     cmap='plasma',
                     s=100,
                     alpha=0.85,
                     edgecolors='black')
